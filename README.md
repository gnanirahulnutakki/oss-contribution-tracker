...
| External pull requests reviewed | 15 | 12 | Target met |
...
| [open-telemetry/otel-arrow#3572](https://github.com/open-telemetry/otel-arrow/pull/3572)<br>fix(filter): reject unknown config fields | author | **PR open** | 77 checks passed · expected CI gate | Link and verify the commit email on GitHub, then complete EasyCLA; the PR is assigned, ready, twice approved, and all technical checks pass. |
...
Last public state change recorded: **2026-07-24T19:31:37+00:00**.
