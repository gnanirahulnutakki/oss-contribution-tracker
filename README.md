...
| [PrefectHQ/fastmcp#4625](https://github.com/PrefectHQ/fastmcp/pull/4625)<br>fix: use Python field name for structured task results | author | **Closed** | 10 checks passed · expected CI gate | Wait for issue assignment; the existing pull request will reopen automatically. |
...
| [Arize-ai/openinference#3429](https://github.com/Arize-ai/openinference/pull/3429#pullrequestreview-4787290072)<br>fix(anthropic): preserve APIPromise helpers | reviewer | **Review submitted** | 20 checks passed | The consumed asResponse body finding is verified fixed and approved on head d4827bfb; all 16 package tests, type-check, build, lint, and format passed, and all 20 GitHub checks completed without failure. Wait for maintainer action or a changed head. |
...
Last public state change recorded: **2026-07-27T15:19:58+00:00**.
