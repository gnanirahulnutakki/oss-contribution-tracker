...
| [Arize-ai/openinference#3429](https://github.com/Arize-ai/openinference/pull/3429#pullrequestreview-4787290072)<br>fix&#40;anthropic&#41;: preserve APIPromise helpers | reviewer | **Review update available** | 20 non-failing checks &#40;14 passed, 6 skipped&#41; | The consumed asResponse body finding is verified fixed and approved on head d4827bfb; all 16 package tests, type-check, build, lint, and format passed, and all 21 GitHub checks completed without failure. Wait for maintainer action or a changed head. |
...
Last public state change recorded: **2026-08-06T15:04:07+00:00**.
