...
| [envoyproxy/gateway#9574](https://github.com/envoyproxy/gateway/pull/9574)<br>docs: explain backend protocol selection | author | **Awaiting CI approval** | 5 checks passed · workflow approval needed | Wait for Netlify and maintainer approval of GitHub Actions; respond to concrete review feedback, then mark the draft ready when repository checks allow. |
...
Last public state change recorded: **2026-07-24T05:16:54+00:00**.
