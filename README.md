...
| [helm/helm#32339](https://github.com/helm/helm/pull/32339#pullrequestreview-4790319373)<br>fix(scripts): add cache-busting to Helm version checks | reviewer | **Review submitted** | 3 checks passed · workflow approval needed | Our cache-behavior concern and Helm 3/4 parity are verified on bbaf420a; wait for the author to address the open --header readability request and best-effort/testability discussion before re-reviewing. |
...
Last public state change recorded: **2026-07-27T18:43:57+00:00**.
