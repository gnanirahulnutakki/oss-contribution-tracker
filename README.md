...
| [microsoft/autogen#7994](https://github.com/microsoft/autogen/pull/7994#pullrequestreview-4800956307)<br>fix(autogen-ext): skip LangChain callback-manager (run_manager) when inferring tool args schema | reviewer | **Review submitted** | 2 checks passed · workflow approval needed | Re-reviewed exact head 315e4f04: four focused tests, targeted Pyright and mypy, and Ruff lint pass; repository-pinned Ruff format fails on the two new callback-manager signatures. One inline formatter finding is open; wait for an author update without duplicating it. |
...
Last public state change recorded: **2026-07-28T19:11:40+00:00**.
