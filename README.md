...
| [akuity/kargo#6685](https://github.com/akuity/kargo/issues/6685)<br>Webhooks server &#40;kubernetes-webhooks-server&#41; is missing probe support that all other servers have | assignee | **Assigned** | assigned to @gnanirahulnutakki | A private, uncommitted implementation is fully qualified on exact main a8df2f95: controller-runtime serves pod-local health endpoints, startup/readiness verify the webhook TLS listener, liveness remains process-only, and Helm defaults/overrides/disablement are covered. Full race tests, Go lint, 151 chart tests, chart lint, generated docs, and strict manifest validation pass. Keep it unpublished at 6/4; recheck live assignment, competing work, main, and capacity before committing. |
...
Last public state change recorded: **2026-08-11T19:06:13+00:00**.
