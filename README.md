...
| [microsoft/autogen#7994](https://github.com/microsoft/autogen/pull/7994#pullrequestreview-4776009034)<br>fix(autogen-ext): skip LangChain callback-manager (run_manager) when inferring tool args schema | reviewer | **Review update available** | 2 checks passed · workflow approval needed | Both callbacks filtering and TypedDict test-typing findings are verified fixed on head c1b1fc24; wait for maintainer review and CI. |
...
Last public state change recorded: **2026-07-28T18:53:33+00:00**.
